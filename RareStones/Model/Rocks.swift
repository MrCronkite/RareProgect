...
struct RockID: Decodable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case isFavorite = "is_favorite"
        case zodiacs, articles
        case chemicalFormula = "chemical_formula"
        case colors, description, hardness
...
struct RockTags: Decodable {
    let count: Int
    let next, previous: JSONNull?
    let results: [RockTagsResult]
}

struct RockTagsResult: Decodable {
    let id: Int
    let name: String
    let image: String
    let pricePerCaratFrom, pricePerCaratTo: String?
...
// MARK: - ZodiacElement
struct ZodiacElement: Decodable {
    let id: Int
    let zodiac: ZodiacZodiac
    let description: String
}

// MARK: - ZodiacZodiac
struct ZodiacZodiac: Decodable {
    let id: Int
    let name, image, dateRange, planet: String
    let element, chakra: String
